...
package scouts.camp_details_sa_0_1;
...
/**
 * Job: Camp_details_SA Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Camp_details_SA implements TalendJob {
	...
	private final String jobName = "Camp_details_SA";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Camp_details_SA.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Camp_details_SA.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_SCOUTS_Camp_details_SA = new byte[0];
		static byte[] commonByteArray_SCOUTS_Camp_details_SA = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SCOUTS_Camp_details_SA.length) {
					if (length < 1024 && commonByteArray_SCOUTS_Camp_details_SA.length == 0) {
						commonByteArray_SCOUTS_Camp_details_SA = new byte[1024];
					} else {
						commonByteArray_SCOUTS_Camp_details_SA = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SCOUTS_Camp_details_SA, 0, length);
				strReturn = new String(commonByteArray_SCOUTS_Camp_details_SA, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SCOUTS_Camp_details_SA, 0, length);
				strReturn = new String(commonByteArray_SCOUTS_Camp_details_SA, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SCOUTS_Camp_details_SA) {
				...
				try {
					...
					this.participants = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.participants, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("camp_details_sa");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("camp_details_sa");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:c/bikHws6sxIsOBD/9vaeHyPmwF5cbfnCnliq+MWhd4tgg==");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("camp_details_sa"))
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"numero\" VARCHAR(10)  ,\"annee\" INT4 ,\"pays\" VARCHAR(100)  ,\"lieu\" VARCHAR(150)  ,\"participants\" VARCHAR(10)  ,\"notes\" VARCHAR(255)  ,\"countries\" VARCHAR(10)  )");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE ");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"numero\",\"annee\",\"pays\",\"lieu\",\"participants\",\"notes\",\"countries\") VALUES (?,?,?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"numero\" = ?,\"annee\" = ?,\"pays\" = ?,\"lieu\" = ?,\"participants\" = ?,\"notes\" = ?,\"countries\" = ? WHERE ";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:rVMYzpfqdnUExCOfZtTd1/pW3zxqqQSRkOfyxg==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/moate/Desktop/ExternData/Camps_Detailles.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.numero = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.numero = null;
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "lieu";

									row1.lieu = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.lieu = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.participants = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (checkCount_tDBOutput_1 > 0) {
									if (row1.numero == null) {
										...
										pstmtUpdate_tDBOutput_1.setString(1, row1.numero);
									}

									if (row1.annee == null) {
										pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
									} else {
										pstmtUpdate_tDBOutput_1.setInt(2, row1.annee);
									}

									if (row1.pays == null) {
										pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(3, row1.pays);
									}

									if (row1.lieu == null) {
										pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(4, row1.lieu);
									}

									if (row1.participants == null) {
										pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(5, row1.participants);
									}

									if (row1.notes == null) {
										pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(6, row1.notes);
									}

									if (row1.countries == null) {
										pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(7, row1.countries);
									}
									...
									if (row1.numero == null) {
										...
										pstmtInsert_tDBOutput_1.setString(1, row1.numero);
									}

									if (row1.annee == null) {
										pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
									} else {
										pstmtInsert_tDBOutput_1.setInt(2, row1.annee);
									}

									if (row1.pays == null) {
										pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(3, row1.pays);
									}

									if (row1.lieu == null) {
										pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(4, row1.lieu);
									}

									if (row1.participants == null) {
										pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(5, row1.participants);
									}

									if (row1.notes == null) {
										pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(6, row1.notes);
									}

									if (row1.countries == null) {
										pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(7, row1.countries);
									}
	...
	public static void main(String[] args) {
		final Camp_details_SA Camp_details_SAClass = new Camp_details_SA();

		int exitCode = Camp_details_SAClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Camp_details_SA.class.getClassLoader()
					.getResourceAsStream("scouts/camp_details_sa_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Camp_details_SA.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Camp_details_SA");
		}
...
/************************************************************************************************
 * 64572 characters generated by Talend Open Studio for Data Integration on the
 * March 28, 2026 at 10:45:55 PM CET
 ************************************************************************************************/