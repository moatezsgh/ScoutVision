...
package scouts.exchange_sa_0_1;
 ...
 * @status
 */
public class Exchange_SA implements TalendJob {
	...
	private final String jobName = "Exchange_SA";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Exchange_SA.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_SCOUTS_Exchange_SA = new byte[0];
		static byte[] commonByteArray_SCOUTS_Exchange_SA = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SCOUTS_Exchange_SA.length) {
					if (length < 1024 && commonByteArray_SCOUTS_Exchange_SA.length == 0) {
						commonByteArray_SCOUTS_Exchange_SA = new byte[1024];
					} else {
						commonByteArray_SCOUTS_Exchange_SA = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SCOUTS_Exchange_SA, 0, length);
				strReturn = new String(commonByteArray_SCOUTS_Exchange_SA, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SCOUTS_Exchange_SA, 0, length);
				strReturn = new String(commonByteArray_SCOUTS_Exchange_SA, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SCOUTS_Exchange_SA) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("exchange_sa");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("exchange_sa");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:B4GhDqQQ16uZhIvF08vsSjNxpVEi1qy6ckwcugOEVX8PXw==");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("exchange_sa"))
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:SP8oLxy0ZXZ7wKN+lCJL/g4ZYab3llNO9j6PKQ==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/moate/Desktop/ExternData/Exchange_Scrapped.xlsx";
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.numero == null) {
									...
									pstmt_tDBOutput_1.setString(1, row1.numero);
								}

								if (row1.annee == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(2, row1.annee);
								}

								if (row1.pays == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, row1.pays);
								}

								if (row1.lieu == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, row1.lieu);
								}

								if (row1.participants == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, row1.participants);
								}
								...
								if (row1.countries == null) {
									...
									pstmt_tDBOutput_1.setString(7, row1.countries);
								}
	...
	public static void main(String[] args) {
		final Exchange_SA Exchange_SAClass = new Exchange_SA();

		int exitCode = Exchange_SAClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Exchange_SA.class.getClassLoader()
					.getResourceAsStream("scouts/exchange_sa_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Exchange_SA.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Exchange_SA");
		}
...
/************************************************************************************************
 * 64890 characters generated by Talend Open Studio for Data Integration on the
 * March 24, 2026 at 7:23:28 PM CET
 ************************************************************************************************/